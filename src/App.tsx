        ...
        <main>
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                Optimize your supply chain with AI-powered predictions that
                account for real-world factors like sailing time and port
                delays.
              </p>
          ...
          >
            ...
            <div className="flex justify-center">
              <div className="bg-white rounded-lg shadow-md p-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 w-full max-w-md">
                <DollarSign className="w-16 h-16 text-blue-500 mx-auto mb-6" />
      ...
      <footer className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <p className="text-center text-base text-gray-400">
            &copy; 2024 DemandCast. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
