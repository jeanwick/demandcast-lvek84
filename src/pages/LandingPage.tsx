...
import HowItWorksSection from '../landingpagecomponents/howitworks';
...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <NavigationBar 
        toggleDemandForecast={toggleDemandForecast} 
        showDemandForecast={showDemandForecast} 
      />
      ...
      {showDemandForecast ? (
        ...
        <main>
          ...
          <HowItWorksSection />
          <Pricing 
            toggleDemandForecast={() => { throw new Error('Function not implemented.'); }}
          />
